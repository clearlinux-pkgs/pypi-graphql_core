...
Source0  : https://files.pythonhosted.org/packages/5d/dc/faab9e9c5356754be4bc97fd5cceeee7450960269b12e6a035b8c9b53f8b/graphql-core-3.2.2.tar.gz
...
%prep
%setup -q -n graphql-core-3.2.2
cd %{_builddir}/graphql-core-3.2.2
pushd ..
cp -a graphql-core-3.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663888219
