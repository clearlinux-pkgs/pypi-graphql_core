...
Source0  : https://files.pythonhosted.org/packages/66/9e/aa527fb09a9d7399d5d7d2aa2da490e4580707652d3b4fc156996ae88a5b/graphql-core-3.2.4.tar.gz
...
%prep
%setup -q -n graphql-core-3.2.4
cd %{_builddir}/graphql-core-3.2.4
pushd ..
cp -a graphql-core-3.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725491377
