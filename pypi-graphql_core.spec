...
Source0  : https://files.pythonhosted.org/packages/c4/16/7574029da84834349b60ed71614d66ca3afe46e9bf9c7b9562102acb7d4f/graphql_core-3.2.6.tar.gz
...
%prep
%setup -q -n graphql_core-3.2.6
cd %{_builddir}/graphql_core-3.2.6
pushd ..
cp -a graphql_core-3.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737993585
...
cp %{_builddir}/graphql_core-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-graphql_core/189f3af6951df927f31322c8e075cd1ea0032c82 || :
